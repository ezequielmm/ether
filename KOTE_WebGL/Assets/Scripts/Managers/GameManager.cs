...
public class GameManager : SingleTon<GameManager>
{
    ...
    [HideInInspector] public UnityEvent<CombatTurnData> EVENT_ENEMY_ATTACKED = new UnityEvent<CombatTurnData>();
    [HideInInspector] public UnityEvent<CombatTurnData> EVENT_PLAYER_ATTACKED = new UnityEvent<CombatTurnData>();
