...
public class WebSocketManager : MonoBehaviour
{
    ...
    {
        rootSocket.ExpectAcknowledgement<string>(OnRewardSelectedAnswer).Emit(WS_MESSAGE_REWARD_SELECTED, rewardId);
    }

    private void OnRewardSelectedAnswer(string data)
    {
        Debug.LogError(data);
    }
